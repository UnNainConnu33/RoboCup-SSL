...
//    console.debug('A la fin de Translation :Points:',Points)
  ...
  compute(broker: ServiceBroker): boolean {
    ...
    var N: Array<Vector2D>= [ // un caractère doit prendfre 0.9 m Ici il prend 1
      {x:0,y:0},
      {x:0,y:1.5},
      {x:1,y:0},
      {x:1,y:1.5},
    ...
    var O: Array<Vector2D>= [ // un caractère doit prendfre 0.9 m Ici il prend 1
      {x:0,y:0},
      {x:0.5,y:0},      
      {x:1,y:0.2},
      {x:1,y:1.3},
    ...
    var E: Array<Vector2D>= [ // un caractère doit prendfre 0.9 m Ici il prend 1
      {x:0,y:0},
      {x:1,y:0},
      {x:1,y:0.2},
      {x:0.1,y:0.2},
    ...
    var Zero: Array<Vector2D>= [ // un caractère doit prendfre 0.9 m Ici il prend 1
      {x:0,y:0},
      {x:0.5,y:0},      
      {x:1,y:0.2},
      {x:1,y:1.3},
    ...
    var Un: Array<Vector2D>= [ // un caractère doit prendfre 0.9 m Ici il prend 1
      {x:0,y:0},
      {x:0.5,y:0},      
      {x:1,y:0.2},
      {x:1,y:1.3},
